...
class FTGL_EXPORT FTFont
{
    public:
         ...
         *
         * MODIF by ELC (02apr07): 'len' paramenter added:
         * - returns the width of 'len' chars if len is >= 0 ; 
         * - returns the width of the entire string if len < 0
         *
         * @param string    a wchar_t string
         * @return      advance width
         */
        float Advance( const wchar_t* string, int len = -1);
         ...
         * @return      advance width
         */
        float Advance( const char* string, int len = -1);
         ...
         * @param int        the nbr of chars to render, -1 to draw the entire string
         */
        virtual void Render( const char* string, int len, float x, float y);
        //virtual void Render( const char* string, int len = -1);
         ...
         * @param int       the nbr of chars to render, -1 to draw the entire string
         */
        virtual void Render( const wchar_t* string, int len, float x, float y);
        //EX: virtual void Render( const wchar_t* string, int len = -1);
