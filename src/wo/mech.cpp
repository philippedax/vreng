...
void Mech::funcs()
{
  setActionFunc(MECH_TYPE, 0, O_ACTION still, "Still");
  setActionFunc(MECH_TYPE, 1, O_ACTION animate, "Anim");
  setActionFunc(MECH_TYPE, 2, O_ACTION walk, "Walk");
  setActionFunc(MECH_TYPE, 3, O_ACTION moveObject, "Move");
}
