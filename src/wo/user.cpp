...
#include "vrsql.hpp"	// getCountCart
...
void User::funcs()
{
  getPropertyFunc(USER_TYPE, PROPHNAME, _Payload get_username);
  getPropertyFunc(USER_TYPE, PROPMENSURATION, _Payload get_mensuration);
  getPropertyFunc(USER_TYPE, PROPMAPFRONT, _Payload get_mapfront);
  getPropertyFunc(USER_TYPE, PROPMAPBACK, _Payload get_mapback);
  getPropertyFunc(USER_TYPE, PROPMAPLEFT, _Payload get_mapleft);
  getPropertyFunc(USER_TYPE, PROPMAPRIGHT, _Payload get_mapright);
  getPropertyFunc(USER_TYPE, PROPXY, _Payload u_get_xy);
  getPropertyFunc(USER_TYPE, PROPZ, _Payload u_get_z);
  getPropertyFunc(USER_TYPE, PROPAZ, _Payload u_get_az);
  getPropertyFunc(USER_TYPE, PROPAY, _Payload u_get_ay);
  getPropertyFunc(USER_TYPE, PROPAX, _Payload u_get_ax);
  getPropertyFunc(USER_TYPE, PROPMSG, _Payload get_msg);
  getPropertyFunc(USER_TYPE, PROPVRE, _Payload get_vre);
  getPropertyFunc(USER_TYPE, PROPWEB, _Payload get_web);
  getPropertyFunc(USER_TYPE, PROPSSRC, _Payload get_ssrc);
  getPropertyFunc(USER_TYPE, PROPRTCPNAME, _Payload get_rtcpname);
  getPropertyFunc(USER_TYPE, PROPRTCPEMAIL, _Payload get_rtcpemail);
  getPropertyFunc(USER_TYPE, PROPMODEL, _Payload get_avatar);
  getPropertyFunc(USER_TYPE, PROPFACE, _Payload get_face);
  getPropertyFunc(USER_TYPE, PROPSEX, _Payload get_sex);
  getPropertyFunc(USER_TYPE, PROPHEAD, _Payload get_head);
  getPropertyFunc(USER_TYPE, PROPSKIN, _Payload get_skin);
  getPropertyFunc(USER_TYPE, PROPBUST, _Payload get_bust);
  getPropertyFunc(USER_TYPE, PROPRAY, _Payload get_ray);

  putPropertyFunc(USER_TYPE, PROPHNAME, _Payload put_username);
  putPropertyFunc(USER_TYPE, PROPMENSURATION, _Payload put_mensuration);
  putPropertyFunc(USER_TYPE, PROPMAPFRONT, _Payload put_mapfront);
  putPropertyFunc(USER_TYPE, PROPMAPBACK, _Payload put_mapback);
  putPropertyFunc(USER_TYPE, PROPMAPLEFT, _Payload put_mapleft);
  putPropertyFunc(USER_TYPE, PROPMAPRIGHT, _Payload put_mapright);
  putPropertyFunc(USER_TYPE, PROPXY, _Payload put_xy);
  putPropertyFunc(USER_TYPE, PROPZ, _Payload put_z);
  putPropertyFunc(USER_TYPE, PROPAZ, _Payload put_az);
  putPropertyFunc(USER_TYPE, PROPAY, _Payload put_ay);
  putPropertyFunc(USER_TYPE, PROPAX, _Payload put_ax);
  putPropertyFunc(USER_TYPE, PROPMSG, _Payload put_msg);
  putPropertyFunc(USER_TYPE, PROPVRE, _Payload put_vre);
  putPropertyFunc(USER_TYPE, PROPWEB, _Payload put_web);
  putPropertyFunc(USER_TYPE, PROPSSRC, _Payload put_ssrc);
  putPropertyFunc(USER_TYPE, PROPRTCPNAME, _Payload put_rtcpname);
  putPropertyFunc(USER_TYPE, PROPRTCPEMAIL, _Payload put_rtcpemail);
  putPropertyFunc(USER_TYPE, PROPMODEL, _Payload put_avatar);
  putPropertyFunc(USER_TYPE, PROPFACE, _Payload put_face);
  putPropertyFunc(USER_TYPE, PROPSEX, _Payload put_sex);
  putPropertyFunc(USER_TYPE, PROPHEAD, _Payload put_head);
  putPropertyFunc(USER_TYPE, PROPSKIN, _Payload put_skin);
  putPropertyFunc(USER_TYPE, PROPBUST, _Payload put_bust);
  putPropertyFunc(USER_TYPE, PROPRAY, _Payload put_ray);

  setActionFunc(USER_TYPE, UserAction::UA_BULLET, _Action createBullet, "");
  setActionFunc(USER_TYPE, UserAction::UA_DART, _Action createDart, "");
  setActionFunc(USER_TYPE, UserAction::UA_FOVYDEF, _Action defaultZoom, "");
  setActionFunc(USER_TYPE, UserAction::UA_FOVYLESS, _Action increaseZoom, "");
  setActionFunc(USER_TYPE, UserAction::UA_FOVYMORE, _Action decreaseZoom, "");
  setActionFunc(USER_TYPE, UserAction::UA_FOVYSET, _Action setZoom, "");
  setActionFunc(USER_TYPE, UserAction::UA_LSPEEDDEF, _Action defaultLinearSpeed, "");
  setActionFunc(USER_TYPE, UserAction::UA_LSPEEDLESS, _Action decreaseLinearSpeed, "");
  setActionFunc(USER_TYPE, UserAction::UA_LSPEEDMORE, _Action increaseLinearSpeed, "");
  setActionFunc(USER_TYPE, UserAction::UA_ASPEEDDEF, _Action defaultAngularSpeed, "");
  setActionFunc(USER_TYPE, UserAction::UA_ASPEEDLESS, _Action decreaseAngularSpeed, "");
  setActionFunc(USER_TYPE, UserAction::UA_ASPEEDMORE, _Action increaseAngularSpeed, "");
  setActionFunc(USER_TYPE, UserAction::UA_PAUSE, _Action pause, "");
  setActionFunc(USER_TYPE, UserAction::UA_PAUSEON, _Action pauseOn, "");
  setActionFunc(USER_TYPE, UserAction::UA_PAUSEOFF, _Action pauseOff, "");
  setActionFunc(USER_TYPE, UserAction::UA_SETLSPEED, _Action setLspeed, "");
  setActionFunc(USER_TYPE, UserAction::UA_SETASPEED, _Action setAspeed, "");
  ...
  setActionFunc(USER_TYPE, UserAction::UA_TPVIEWROTD, _Action thirdPersonView_RotD, "");
  setActionFunc(USER_TYPE, UserAction::UA_TPVIEWROTN, _Action thirdPersonView_Near, "");
  setActionFunc(USER_TYPE, UserAction::UA_TPVIEWROTF, _Action thirdPersonView_Far, "");
  setActionFunc(USER_TYPE, UserAction::UA_SETROLL, _Action setRoll, "");
  setActionFunc(USER_TYPE, UserAction::UA_SETPITCH, _Action setPitch, "");
  setActionFunc(USER_TYPE, UserAction::UA_PITCHMORE, _Action increasePitch, "");
  setActionFunc(USER_TYPE, UserAction::UA_PITCHLESS, _Action decreasePitch, "");
  setActionFunc(USER_TYPE, UserAction::UA_ROLLMORE, _Action increaseRoll, "");
  setActionFunc(USER_TYPE, UserAction::UA_ROLLLESS, _Action decreaseRoll, "");
  setActionFunc(USER_TYPE, UserAction::UA_FLYAWAY, _Action flyaway, "");
  setActionFunc(USER_TYPE, UserAction::UA_TOLAND, _Action toland, "");
}
