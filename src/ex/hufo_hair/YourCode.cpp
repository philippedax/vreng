...
char szAppName[] = "Hufo's Hair Simulation";
...
//#endif
	switch(MessageBox(NULL,
		"Keys:\n"
		" SPACE: enable/disable model aff\n"
		" ENTER: enable/disable camera rotation\n"
		"\n"
...
void Render()
{
	...
	{ // aff framerate
		char buf[256];
		sprintf(buf,"%s - %g fps (%d polys, %d lines)",szAppName,nf/(fTime-secTime),obj.nbf,HAIRNBLINE);
