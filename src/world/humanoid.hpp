...
class Humanoid: public Object {
 private:
  ...
  uint8_t bapparams;		///< number of parameters
 ...
 private:
  ...
  static void yes_cb(Humanoid *humanoid, void *d, time_t s, time_t u);
  static void no_cb(Humanoid *humanoid, void *d, time_t s, time_t u);
