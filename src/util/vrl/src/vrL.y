...
%type <assignchaine>	        	STRING_ASSIGNMENT
%type <assignexpr>	        	EXPRESSION_ASSIGNMENT
%type <assignvariable>	        	VARIABLE_ASSIGNMENT
%type <assignnouvelobjet>		NEWOBJECT_ASSIGNMENT
...
%type <exprliste>			EXPRESSIONLIST
%type <expr>		        	EXPRESSION
%type <calculableexpr>	        	CALCULABLE_EXPRESSION
%type <exprlogique>	        	LOGICAL_EXPRESSION
...
COMPLEX_DECLARATION : VARKEY VARIABLE EQUALKEY STRING SEMICOLONKEY
	...
	| VARKEY VARIABLE EQUALKEY EXPRESSION SEMICOLONKEY
		{ $$ = new DeclarationComplexeExpr($2, $4) ; }
/*
