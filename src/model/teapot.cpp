...
/* 306 vertices */
const point Teapot::vertices[306] = {
...
const int Teapot::indices[32][4][4] = {
...
void Teapot::divide_curve(point *c, point *r, point *l)
{
  for (int i=0; i<3 ; i++) {
    point t;
 ...
 */
void Teapot::divide_patch(point p[4][4], uint8_t n)
{
...
void Teapot::draw_patch(point p[4][4])
{
  point n;
